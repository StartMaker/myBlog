...
const read = (file, optsOrEncoding) => {
  const encoding = (optsOrEncoding === null || optsOrEncoding === void 0 ? void 0 : optsOrEncoding.encoding) || optsOrEncoding;
  file.atime = new Date();
...
function () {
  function MemoryFs() {
    this.addFile = (p, data, updateMtime = false) => {
      ...
      this.paths.set(p, {
        ...
        mtime: !updateMtime && existing && existing.hash === hash ? existing.mtime : new Date()
      });
    };
  ...
  var _proto = MemoryFs.prototype;

  /** stream methods taken from memory-fs */
  _proto.createReadStream = function createReadStream(p, options) {
  ...
  _proto.createWriteStream = function createWriteStream(p) {
